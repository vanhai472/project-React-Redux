...
export const getTypeBufVideo = params => ({
  type: userConstant.GET_TYPE_BUFF_VIDEO,
  payload: {
    params
  }
});

export const getTypeBufVideoSuccess = data => ({
  type: userConstant.GET_TYPE_BUFF_VIDEO_SUCCESS,
  payload: {
    data
  }
});

export const getTypeBufVideoFailed = error => ({
  type: userConstant.GET_TYPE_BUFF_VIDEO_FAILED,
  payload: {
    error
  }
});