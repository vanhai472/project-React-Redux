...
const initialState = {
  ...
  dataBalance: {},
  dataTypeBuffVideo: [],
  isLoadingBuffVideo: false,
  isLoadingBuffSub: false
};
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.GET_TYPE_BUFF_VIDEO: {
      return {
        ...state
      };
    }
    case types.GET_TYPE_BUFF_VIDEO_SUCCESS: {
      const { data } = action.payload;
      return {
        ...state,
        dataTypeBuffVideo: [...data]
      };
    }
    case types.GET_TYPE_BUFF_VIDEO_FAILED: {
      return {
        ...state
        // error
      };
